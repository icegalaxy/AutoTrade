...
public class XMLWatcher implements Runnable
{
	...
	static MyFile Stair = new MyFile("C:\\Users\\joecheung0\\Google Drive\\TradeData\\stair.csv");
...
//		tSt5.start();
		...
		while (Global.isRunning())
		{
			...
			if (91420 < GetData.getTimeInt() && GetData.getTimeInt() < 120000 && Global.getOpen() == 0)
			{
				setOpenPrice();
